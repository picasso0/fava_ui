    ...
    render(){
        return <div className="border-end sidenav" id="sidebar-wrapper">
            ...
            <PerfectScrollbar className="sidebar-items">
                ...
                {/* <li className="mb-1">
                        <Link tag="a" className="" to="/personnels">
                        <i className="fa fa-users" aria-hidden="true"></i> پرسنل
                        </Link>
                    </li> */}
                    <li className="mb-1">
                        <Link tag="a" className="" to="/Companies">
                        <i className="fa fa-users" aria-hidden="true"></i> شرکت ها
                        </Link>
                    </li>
                    {/* <li className="mb-1">
