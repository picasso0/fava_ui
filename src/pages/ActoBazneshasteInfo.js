...
function ActoBazneshasteInfo() {
  ...
  const fetchData = async () => {
    ...
    try {
      const url = `${process.env.REACT_APP_API_URL}/api/v1/view/ActoBazneshasteInfo?id=${id}&skip=${skip}&limit=${limit}`;
...
export default adminLayout(ActoBazneshasteInfo);
