...
function ShaghelinInfo() {
  ...
  const fetchData = async () => {
    ...
    try {
      const url = `${process.env.REACT_APP_API_URL}/api/v1/view/ShaghelinInfo?id=${id}&skip=${skip}&limit=${limit}`;
...
export default adminLayout(ShaghelinInfo);
